...
R={  'MD101.mat' 'MD102.mat' 'MD103.mat' 'MD104.mat' 'MD105.mat' 'MD106.mat'... 
     ...
     'MD120.mat' 'MD121.mat' 'MD122.mat' 'MD123.mat' 'MD124.mat' 'MD125.mat' 'MD126.mat'...
     'MD127.mat' 'MD128.mat' 'MD129.mat' 'MD130.mat'};
...
for i = 1:length(R) % for data set
   ...
   [ pMB(i,:) pMBPOS(i,:) pMBNEG(i,:) pMF(i,:) pwin(i,:) barvtot(i,:) lastseendistot(i,:) RT(i,:) cbarctot(i,:)...
       ...
       pMBTNA(i,:) baraaqtot(i,:) errbaraaqtot(i,:) last_chosen_distance(i,:) MBMFD(i,:) baraaqa(i,:) errbaraaqa(i,:) MBMFDII(i,:) errMBMFD(i,:) baraRT(i,:) errbaraRT(i,:) RTinf(i,:) errRTinf(i,:)] = GraphingTR(result);
...
%% attn effect on ratings on win/loss of unchosen shape 
...
% looks at the difference between the last rating of the shape and the
% currenet according to the conditions
...
% ratings split by condition for the unchosen shape 
...
% ratings chanages for chosen shape but with the fist 4 with attn and the
% last 4 without 

%% classicalMBplotting (w/o MD106, 118, 126, 129, 130) (G2)
R={  'MD101.mat' 'MD102.mat' 'MD103.mat' 'MD104.mat' 'MD105.mat' ... 
     'MD107.mat' 'MD108.mat' 'MD109.mat' 'MD110.mat' 'MD111.mat' 'MD112.mat'...
     'MD113.mat' 'MD114.mat' 'MD115.mat' 'MD116.mat' 'MD117.mat' 'MD119.mat'...
     'MD120.mat' 'MD121.mat' 'MD122.mat' 'MD123.mat' 'MD124.mat' 'MD125.mat' ...
     'MD127.mat' 'MD128.mat' 'MD126.mat'};
 % note on who's the MB negs 
 % MD106 ruled out due to insufficent SD of ratings - only 12 pixels
 % MF118 MB neg
 % MD126 MB neg
 % MD129 MB neg
 % MD130 excluded due to computer error 
...
meanbias_tot = mean(bias_tot);%this is the total bias in the cohort
...
xlabel('win/loss divied by con/incon');
ylabel('Stay Probability');
title('Effect of WM on explicit stay prob');
hold off
